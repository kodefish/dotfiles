...
#+begin_src emacs-lisp
  (use-package evil
    ...
    (define-key evil-motion-state-map (kbd "SPC w d") 'evil-window-delete)
...
** Appearance
Currently using the [[https://github.com/bbatsov/zenburn-emacs][zenburn theme]] for dark and [[https://github.com/manuel-uberti/doneburn-theme][doneburn theme]] for light. I use =heaven-and-hell= to toggle between the two manually.
  ...
  (use-package heaven-and-hell
    ...
    (setq heaven-and-hell-themes
          '((light . material-light)
            (dark . material))) ;; Themes can be the list: (dark . (tsdh-dark wombat))
...
*** Expand parantheses
Expand parantheses automatically, kinda like smartparens
#+begin_src emacs-lisp
...
#+end_src
** Magit
=magit= is a git-porcelaine inside of emacs. Basically wraps around git commands, making git a pleasure to use inside of emacs.
#+begin_src emacs-lisp
  (use-package magit
    :ensure t
    :config
