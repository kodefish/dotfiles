return {
    ...
    config = function()
        ...
        local netcoredbg_bin = "/opt/homebrew/bin/netcoredbg" -- adjust if needed
        ...
        -- Visuals
        vim.fn.sign_define("DapBreakpoint", { text = "●", texthl = "", numhl = "", linehl = "" })
        vim.fn.sign_define("DapStopped", { text = "→", texthl = "", numhl = "", linehl = "" })
